...
include $(PREBUILT_STATIC_LIBRARY)
include $(CLEAR_VARS) 
LOCAL_MODULE := libopus-prebuilt 
LOCAL_SRC_FILES := $(TARGET_ARCH_ABI)/libopus.a
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/opus/
...
LOCAL_STATIC_LIBRARIES := libogg-prebuilt libvorbis-prebuilt libvorbisenc-prebuilt libvpxenc-prebuilt libopus-prebuilt
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE    := krcam
LOCAL_SRC_FILES := krcam.cpp krcam_util.c
LOCAL_STATIC_LIBRARIES := cpufeatures libogg-prebuilt libvpx-prebuilt libvorbisenc-prebuilt libvorbis-prebuilt  libopus-prebuilt libkrad-prebuilt 
